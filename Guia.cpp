...
float   --  flotantes = {1.2,2.3,3.4,4.5,...} 
...
struct 'nombre de la estrutura'{

    tipo de datos que va a llevar la estructura
...
struct alumno{
    int edad;
    char nombre[20];
}   alum ;                  ---- declaramos la variable alum de tipo estruct alumno


Tambien cuando nos refiramos a la estructura podemos hacer lo siguiente
